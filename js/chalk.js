...
document.addEventListener('keydown', function(event) {
    ...
    if (event.key === 'Backspace') {
        // Do something when backspace key is pressed
        console.log('Backspace key pressed!');
        // Replace 'console.log' with whatever action you want to perform
   
   	$('#chalkboard').remove();
	$('.chalk').remove();
var chalkboardCanvas = document.getElementById('chalkboard');
if (chalkboardCanvas) {
    chalkboardCanvas.remove();
}

// Remove the div element with class "chalk"
var chalkDiv = document.querySelector('.chalk');
if (chalkDiv) {
    chalkDiv.remove();
}
    }
